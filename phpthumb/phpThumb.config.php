...
$PHPTHUMB_CONFIG['high_security_password']      = 'oX`81ms85&{9sH!C$cIO';      // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpThumb.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
...
$PHPTHUMB_CONFIG['error_bgcolor']               = 'FFF'; // background color of error message images
$PHPTHUMB_CONFIG['error_textcolor']             = '333'; // color of text in error messages
...
function getPHPThumbHash($ParameterString){
	global $PHPTHUMB_CONFIG;
    return md5($ParameterString.$PHPTHUMB_CONFIG['high_security_password']);
}
